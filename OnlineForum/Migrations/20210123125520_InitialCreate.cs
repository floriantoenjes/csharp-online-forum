        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoardId1 = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastThreadId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Boards_Threads_LastThreadId",
                        column: x => x.LastThreadId,
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "JoinedAt", "LastSeen", "PostCount", "Reputation", "RoleId", "Signature", "Username" },
                values: new object[] { 1, new DateTime(2021, 1, 23, 13, 55, 20, 609, DateTimeKind.Local).AddTicks(8514), new DateTime(2021, 1, 23, 13, 55, 20, 608, DateTimeKind.Local).AddTicks(2857), 0, 0, 1, "Cool Signature", "Florian" });

            migrationBuilder.CreateIndex(
                name: "IX_Boards_LastThreadId",
                table: "Boards",
                column: "LastThreadId",
                unique: true,
                filter: "[LastThreadId] IS NOT NULL");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Threads_Boards_BoardId1",
                table: "Threads",
                column: "BoardId1",
