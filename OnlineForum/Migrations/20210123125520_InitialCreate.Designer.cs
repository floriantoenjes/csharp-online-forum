...
namespace OnlineForum.Migrations
{
    ...
    [Migration("20210123125520_InitialCreate")]
            ...
            modelBuilder.Entity("OnlineForum.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            JoinedAt = new DateTime(2021, 1, 23, 13, 55, 20, 609, DateTimeKind.Local).AddTicks(8514),
                            LastSeen = new DateTime(2021, 1, 23, 13, 55, 20, 608, DateTimeKind.Local).AddTicks(2857),
                            PostCount = 0,
                            Reputation = 0,
                            RoleId = 1,
