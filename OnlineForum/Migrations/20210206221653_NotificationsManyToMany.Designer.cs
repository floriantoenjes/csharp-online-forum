...
namespace OnlineForum.Migrations
{
    ...
    [Migration("20210206221653_NotificationsManyToMany")]
    partial class NotificationsManyToMany
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineForum.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineForum.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "0543d3c8-d2b2-4795-83ff-e4e2b1457d72",
                            Name = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("OnlineForum.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "73f34ef0-3dcd-41db-9d03-350eb39c8632",
                            EmailConfirmed = false,
                            JoinedAt = new DateTime(2021, 2, 6, 23, 16, 52, 774, DateTimeKind.Local).AddTicks(5115),
                            LastSeen = new DateTime(2021, 2, 6, 23, 16, 52, 772, DateTimeKind.Local).AddTicks(8377),
            ...
            modelBuilder.Entity("NotificationUser", b =>
                {
                    b.HasOne("OnlineForum.Models.Notification", null)
                        .WithMany()
